<?php
// 🔒 DOBLE SEGURIDAD: Solo Admin (1) y RR.HH. (3) pueden ver reportes financieros
            ...
            <form action="index.php" method="GET" class="row align-items-center">
                ...
                <div class="col-md-3 mt-4 text-end">
                    <?php if (count($listaReporte) > 0): ?>
                        <a href="#" class="btn btn-sm btn-danger fw-bold shadow-sm me-1">📄 PDF</a>
                        <a href="#" class="btn btn-sm btn-success fw-bold shadow-sm">📗 Excel</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
                    ...
                    <?php if (count($listaReporte) > 0): ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><span class="badge bg-info text-dark"><?php echo $r['nombre_cargo']; ?></span></td>
